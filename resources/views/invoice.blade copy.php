...
<body>
    <table class="no-border">
        <tr>
            <td><img src="{{ '/'.$order->company->logo ?? 'https://media.istockphoto.com/id/2173059563/vector/coming-soon-image-on-white-background-no-photo-available.jpg?s=612x612&w=0&k=20&c=v0a_B58wPFNDPULSiw_BmPyhSNCyrP_d17i2BPPyDTk=' }}" width="80"></td>
    ...
    <table class="no-border">
        <tr>
            ...
            <td style="padding-left: 70px">
                ...
                <strong>Due Date:</strong> {{ $order->created_at->addDays(10)->format('d-m-Y') }}
            </td>
        <tr>
            <td>
