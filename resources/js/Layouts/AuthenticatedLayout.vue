                ...
                <template v-for="(item,key) in $page.props.auth.menu" :key="key">
                    <template v-if="item.children.length > 0">
                        <li class="nav-item" :class="route().current(item.route) ? 'active' : ''">
                            <a class="nav-link collapsed" href="#" data-toggle="collapse" :data-target="`#menuItem${key}`"
                                aria-expanded="true" :aria-controls="`menuItem${key}`">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{$page.props.auth.user.name}}</span>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <Link :href="route('logout')" method="post" as="button" class="btn btn-primary">Logout</Link>
                    </div>
                </div>
            </div>
        </div>
