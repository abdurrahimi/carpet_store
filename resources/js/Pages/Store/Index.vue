                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <Multiselect
                            ...
                            :class="{
                                'is-invalid': $page?.props?.errors?.manager?.id,
                            }"
                        ></Multiselect>
                        <span class="text-danger">{{
                            $page?.props?.errors?.manager?.id
                        }}</span>
                    </div>
        ...
        async submitForm() {
            try {
                ...
                if (this.form.id == "" || this.form.id == null) {
                    ...
                    return router.put(
                        this.route("store.update", this.form.id),
                        this.form,
                        {
                            preserveScroll: true,
                            onSuccess: () => {
